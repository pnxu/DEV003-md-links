...
// Check if given p ath is an absolute route.
// return Boolean
...
// return String
const resolveToAbsolutePath = (userPath) => path.resolve(userPath);
...
//        - DRY dont repeat yourself (dont re-declare functions that do the exact same thing)
...
// This function reads files in a directory and their subdirectories recursively, and filter the .md files.
...
console.log(getMdFilesInDirectory('/home/pnxu/workspace/DEV003-md-links'));
